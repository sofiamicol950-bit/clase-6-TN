...
## Que se encontrara en este repositor?
1. Desarrollo de la capa 1 con Claude
* A partir de una Base de Datos de Excel, solicítanos que genere indicadores en Excel para posteriores estudios.
* Luego en estos indicadores solicitamos que genere un html para publicar en Netlify.
